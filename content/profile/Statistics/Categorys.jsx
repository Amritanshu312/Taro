...
const Categorys = ({ user, lists }) => {
  ...
  return (
    <div className="flex justify-center gap-6" >
      ...
      <div className="w-64 h-44 rounded-lg border-2 border-[#fce3ee88] flex flex-col justify-between items-center cursor-pointer text-white py-6 transition-all hover:bg-[#f485b0] hover:shadow-[0px_0px_20px_2px_#f485b0] group">
      ...
      <div className="w-64 h-44 mt-12 rounded-lg border-2 border-[#d9e8d988] flex flex-col justify-between items-center cursor-pointer text-white py-6 transition-all hover:bg-[#d9e8d9] hover:shadow-[0px_0px_20px_2px_#d9e8d9] group">
      ...
      <div className="w-64 h-44 rounded-lg border-2 border-[#edd8c688] flex flex-col justify-between items-center cursor-pointer text-white py-6 transition-all hover:bg-[#ebe3dc] hover:shadow-[0px_0px_20px_2px_#ebe3dc] group">
      ...
      <div className="w-64 h-44 mt-12 rounded-lg border-2 border-[#c1dbf388] flex flex-col justify-between items-center cursor-pointer text-white py-6 transition-all hover:bg-[#70bcebea] hover:shadow-[0px_0px_20px_2px_#2e82cf] group">
